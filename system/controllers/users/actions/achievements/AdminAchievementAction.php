...
/**
 * Абстрактный базовый класс для всех административных действий модуля достижений
...
abstract class AdminAchievementAction {
    ...
    public function __construct($db, $params = []) {
        ...
        // Инициализация модели пользователей (содержит методы для работы с достижениями)
